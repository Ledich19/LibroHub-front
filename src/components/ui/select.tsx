...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        `input focus:outline-none focus:ring-0 focus:shadow-none
          w-fit
         data-[placeholder]:text-base-content/70
         [&_svg:not([class*='text-'])]:text-base-content/70
         focus-visible:border-accent-content
         focus-visible:border-accent-content
         focus-visible:ring-accent-content/50 
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          `bg-neutral text-popover-foreground data-[state=open]:animate-in
         ...
         w-fit origin-(--radix-select-content-transform-origin) 
          overflow-x-hidden overflow-y-auto rounded-md border shadow-md text-neutral-content`,
          position === "popper" &&
      ...
      >
        ...
        <SelectPrimitive.Viewport
          className={cn(
            "p-1",
            position === "popper" &&
            "h-[var(--radix-select-trigger-height)] w-full w-fit scroll-my-1"
          )}
        >
          {children}
        </SelectPrimitive.Viewport>
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm outline-hidden
